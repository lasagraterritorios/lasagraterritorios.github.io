...
var informacionPorCP;

fetch('territories.json')
    .then(response => response.json())
    .then(data => {
        // Usa la información cargada desde el archivo JSON
        informacionPorCP = data;

        // Asegúrate de actualizar el contenido de la página después de cambiar el idioma
        // Puedes llamar a la función translatePage aquí si es necesario
    });
